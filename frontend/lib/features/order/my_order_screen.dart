...
class _MyOrderScreenState extends State<MyOrderScreen> {
    ...
    return InkWell(
          ...
          MaterialPageRoute(
            builder:
                (context) => OrderConfirmationScreen(
                  ...
                  isPaymentSuccess: order['isPaid'] ?? false,
                ),
          ),
        );
      },
      child: LayoutBuilder(
        builder: (context, constraints) {
          // responsive dựa vào chiều rộng của card
          double width = constraints.maxWidth;
          bool isTablet = width > 600;

          double fontH3 = isTablet ? 20 : 16;
          double fontBody = isTablet ? 16 : 14;
          double fontSmall = isTablet ? 14 : 12;
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Text(
                        'Mã: $orderCode',
                        style: AppTextStyle.withColor(
                          AppTextStyle.h3.copyWith(fontSize: fontH3),
                  ...
                  Text(
                    'Ngày tạo: $createdAt',
                    style: AppTextStyle.withColor(
                      AppTextStyle.bodySmall.copyWith(fontSize: fontSmall),
                      Colors.grey[600]!,
                    ),
                  ),
                  SizedBox(height: padding / 2),
                  ...
                  if (orderItems.isNotEmpty) ...[
                    ...
                    Text(
                      'Sản phẩm:',
                      style: AppTextStyle.withColor(
                        AppTextStyle.bodyMedium.copyWith(fontSize: fontBody),
                        Theme.of(context).textTheme.bodyLarge!.color!,
                      ),
                    ),
  ...
  Color _getStatusColor(String status) {
    ...
    if (statusLower.contains('xử lý') ||
        statusLower.contains('chờ') ||
      ...
      return Colors.green;
    } else if (statusLower.contains('hủy') ||

...
class TwoFactorScreen extends StatefulWidget {
  final String userId;
  const TwoFactorScreen({Key? key, required this.userId}) : super(key: key);
...
class _TwoFactorScreenState extends State<TwoFactorScreen> {
  ...
  void _handleVerifyOtp() async {
    ...
    final success = await authController.verifyTwoFactorAuth(
      widget.userId,
  ...
  void _handleResend() async {
    ...
    Get.snackbar(
      'Thông báo',
      'Tính năng gửi lại OTP đang được phát triển',
            ...
            child: Padding(
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    Icon(Icons.security, size: 64, color: theme.primaryColor),

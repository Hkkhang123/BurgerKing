...
class FilterBottomSheet {
  static void show(BuildContext context, Function(Map<String, dynamic>) onApplyFilter) {
          ...
          child: Column(
            ...
            children: [
              ...
              Wrap(
                spacing: 8,
                children: [
                  'all', 'pizza', 'burger', 'sushi', 'vietnamese', 'asian', 'western', 'dessert', 'drink'
                ].map((category) {
              ...
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text('${(priceRange.start / 1000).round()}k'),
                  Text('${(priceRange.end / 1000).round()}k'),
                ],
              ),
              ...
              Wrap(
                ...
                children: [
                  ...
                  final isSelected = selectedSortBy == sortOption['value'];
                  return FilterChip(
                    label: Text(sortOption['label']!),
                    selected: isSelected,
                    onSelected: (selected) {
                      setState(() {
                        selectedSortBy = sortOption['value']!;
                      });
                    },
                    backgroundColor: isDark ? Colors.grey[800] : Colors.grey[200],
                    selectedColor: Theme.of(context).primaryColor.withOpacity(0.2),
